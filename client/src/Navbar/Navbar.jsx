...
const Logo = () => {
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection:'column' }}>
      <img src=".\images\movie-review-icon.png" style={{ width: '120px'  }}/>
    </div>
  );
};
const NavLeft = ({ setIsOpen }) => {
  return (
    <div className="flex items-center gap-6">
      ...
      <NavLink text="All Movies" to='/allmovies'/>
      <NavLink text="My Reviews" to='/myreviews'/>
      <NavLink text="Shared With Me"to='/sharedwithme' />
      <NavLink text="All Reviews" to='/allreviews'/>
    </div>
  );
};
